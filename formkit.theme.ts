...
/**
  ...
  *
  * @checksum - d2469ccec63ff66f9c6af302590d7519f5b94ec908c092aff13739ae45eab5a3
  * @variables - radius=rounded-full,accentColor=emerald,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
