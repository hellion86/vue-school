...
<template>
  <div class="flex flex-col justify-center items-center">
    <Table v-if="task">
      ...
      <TableRow>
        <TableHead> Status </TableHead>
          <TableCell>
            <AppPlaceEditStatus v-model="task.status" @commit="updateTask"/>
        </TableCell>
      </TableRow>
      <TableRow>
    ...
    <Button class="self-end mt-3 w-full max-w-40" variant="destructive" @click="triggerDelete">
