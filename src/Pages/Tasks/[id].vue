<script setup lang="ts">
  ...
  await getTask(Number(route.params.id))
        ...
        <TableCell>
          ...
          <div class="flex flex-col justify-between p-3 bg-muted my-2 rounded-md">
            <textarea
              ...
              class="w-full max-w-full overflow-y-auto prose-sm prose border rounded dark:prose-invert hover:border-muted bg-background border-muted p-3"></textarea>
    ...
    <Button
      ...
      <Transition
        ...
        <iconify-icon
          ...
          class="mr-1 animate-spin"></iconify-icon>
        <iconify-icon
          v-else
          icon="lucide:trash-2"
